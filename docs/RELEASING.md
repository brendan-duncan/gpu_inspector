...
It also takes two things out of what Electron ships, which is where 15MB of the download and
73MB of the installed tree went:

- `electronLanguages: [en-US]` keeps one of Electron's 55 Chromium locale bundles. The rest are
