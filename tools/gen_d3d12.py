...
struct serializers are written by hand (src/d3d12/src/serialize.cpp), and what is generated here is
...
Usage: gen_d3d12.py --sdk "<Windows Kits>/10/Include/<version>" --out src/d3d12/gen
"""
import argparse
import os
import re
...
# The interfaces whose vtables the library patches (src/d3d12/src/hook.h): the newest version of each,
...
def emit_vtables(vtables, out_dir):
    ...
    h.append("// C signature for calling the original through the saved entry (src/d3d12/src/hook.h).\n")
