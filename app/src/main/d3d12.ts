...
// layers (d3d12/README.md, "Getting in"): the library has to be inside the process before its
...
/** The variables the capture library reads (d3d12/README.md, "Getting in"). */
