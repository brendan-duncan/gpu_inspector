...
// stage with one part taken out, `vkinsp_replay --ablate` times the draw with each (replay/src/
...
/** The request file `vkinsp_replay --ablate` reads (ReadAblationRequest in replay/src/main.cpp). */
...
/** Parses `vkinsp_replay --ablate-data` (WriteAblationData in replay/src/main.cpp). */
