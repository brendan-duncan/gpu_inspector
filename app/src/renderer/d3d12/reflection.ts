...
// (d3d12/src/shader_reflect.h): per stage, every constant buffer with its members, every bound
...
//
// A snapshot's bindings are keyed the same way (register and space, d3d12/README.md "Bound
