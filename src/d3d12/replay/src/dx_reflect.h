...
template <typename V>
void Reflect(V& v, DXGI_SAMPLE_DESC& s)
{
    R_INT(Count);
    R_INT(Quality);
}
...
template <typename V>
void Reflect(V& v, D3D12_HEAP_PROPERTIES& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_RESOURCE_DESC& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_DEPTH_STENCIL_VALUE& s)
{
    R_FLOAT(Depth);
    R_INT(Stencil);
}
...
template <typename V>
void Reflect(V& v, D3D12_CLEAR_VALUE& s)
{
    R_ENUM(Format, DXGI_FORMAT);
    // No discriminator of its own: the format says which arm the application filled.
    if (dxinsp::FormatOf(s.Format).depth)
        R_STRUCT(DepthStencil);
    else
        v.FixedFloats("Color", s.Color, 4);
}

template <typename V>
void Reflect(V& v, D3D12_BOX& s)
{
    R_INT(left);
    R_INT(top);
    R_INT(front);
...
template <typename V>
void Reflect(V& v, D3D12_VIEWPORT& s)
{
    R_FLOAT(TopLeftX);
    R_FLOAT(TopLeftY);
    R_FLOAT(Width);
...
template <typename V>
void Reflect(V& v, D3D12_SUBRESOURCE_FOOTPRINT& s)
{
    R_ENUM(Format, DXGI_FORMAT);
    R_INT(Width);
    R_INT(Height);
...
template <typename V>
void Reflect(V& v, D3D12_PLACED_SUBRESOURCE_FOOTPRINT& s)
{
    R_INT(Offset);
    R_STRUCT(Footprint);
}
...
template <typename V>
void Reflect(V& v, D3D12_TEXTURE_COPY_LOCATION& s)
{
    R_OBJECT(pResource, "ID3D12Resource");
    R_ENUM(Type, D3D12_TEXTURE_COPY_TYPE);
    if (s.Type == D3D12_TEXTURE_COPY_TYPE_PLACED_FOOTPRINT)
        R_STRUCT(PlacedFootprint);
    else
        R_INT(SubresourceIndex);
}
...
template <typename V>
void Reflect(V& v, D3D12_SHADER_RESOURCE_VIEW_DESC& s)
{
    R_ENUM(Format, DXGI_FORMAT);
    ...
    switch (s.ViewDimension)
    {
        case D3D12_SRV_DIMENSION_BUFFER:
        {
            ...
            b.Int("FirstElement", s.Buffer.FirstElement);
            b.Int("NumElements", s.Buffer.NumElements);
            b.Int("StructureByteStride", s.Buffer.StructureByteStride);
            b.Flags("Flags", s.Buffer.Flags, DX_TABLE(D3D12_BUFFER_SRV_FLAGS));
            break;
        }
        case D3D12_SRV_DIMENSION_TEXTURE1D:
        {
            auto b = v.Nested("Texture1D");
            b.Int("MostDetailedMip", s.Texture1D.MostDetailedMip);
            b.Int("MipLevels", s.Texture1D.MipLevels);
        ...
        case D3D12_SRV_DIMENSION_TEXTURE1DARRAY:
        {
            ...
            b.Int("MostDetailedMip", s.Texture1DArray.MostDetailedMip);
            b.Int("MipLevels", s.Texture1DArray.MipLevels);
            b.Int("FirstArraySlice", s.Texture1DArray.FirstArraySlice);
        ...
        case D3D12_SRV_DIMENSION_TEXTURE2D:
        {
            ...
            b.Int("MostDetailedMip", s.Texture2D.MostDetailedMip);
            b.Int("MipLevels", s.Texture2D.MipLevels);
            b.Int("PlaneSlice", s.Texture2D.PlaneSlice);
            b.Float("ResourceMinLODClamp", s.Texture2D.ResourceMinLODClamp);
            break;
        }
        case D3D12_SRV_DIMENSION_TEXTURE2DARRAY:
        {
            auto b = v.Nested("Texture2DArray");
            b.Int("MostDetailedMip", s.Texture2DArray.MostDetailedMip);
            b.Int("MipLevels", s.Texture2DArray.MipLevels);
            b.Int("FirstArraySlice", s.Texture2DArray.FirstArraySlice);
            b.Int("ArraySize", s.Texture2DArray.ArraySize);
            b.Int("PlaneSlice", s.Texture2DArray.PlaneSlice);
            b.Float("ResourceMinLODClamp", s.Texture2DArray.ResourceMinLODClamp);
            break;
        }
        case D3D12_SRV_DIMENSION_TEXTURE2DMSARRAY:
        {
            auto b = v.Nested("Texture2DMSArray");
            b.Int("FirstArraySlice", s.Texture2DMSArray.FirstArraySlice);
            b.Int("ArraySize", s.Texture2DMSArray.ArraySize);
            break;
        }
        case D3D12_SRV_DIMENSION_TEXTURE3D:
        {
            auto b = v.Nested("Texture3D");
            b.Int("MostDetailedMip", s.Texture3D.MostDetailedMip);
            b.Int("MipLevels", s.Texture3D.MipLevels);
        ...
        case D3D12_SRV_DIMENSION_TEXTURECUBE:
        {
            ...
            b.Int("MostDetailedMip", s.TextureCube.MostDetailedMip);
            b.Int("MipLevels", s.TextureCube.MipLevels);
        ...
        case D3D12_SRV_DIMENSION_TEXTURECUBEARRAY:
        {
            ...
            b.Int("MostDetailedMip", s.TextureCubeArray.MostDetailedMip);
            b.Int("MipLevels", s.TextureCubeArray.MipLevels);
            b.Int("First2DArrayFace", s.TextureCubeArray.First2DArrayFace);
            b.Int("NumCubes", s.TextureCubeArray.NumCubes);
...
template <typename V>
void Reflect(V& v, D3D12_UNORDERED_ACCESS_VIEW_DESC& s)
{
    R_ENUM(Format, DXGI_FORMAT);
    ...
    switch (s.ViewDimension)
    {
        case D3D12_UAV_DIMENSION_BUFFER:
        {
            ...
            b.Int("NumElements", s.Buffer.NumElements);
            b.Int("StructureByteStride", s.Buffer.StructureByteStride);
            b.Int("CounterOffsetInBytes", s.Buffer.CounterOffsetInBytes);
        ...
        {
            auto b = v.Nested("Texture1D");
            b.Int("MipSlice", s.Texture1D.MipSlice);
            break;
        }
        case D3D12_UAV_DIMENSION_TEXTURE1DARRAY:
        {
            auto b = v.Nested("Texture1DArray");
            b.Int("MipSlice", s.Texture1DArray.MipSlice);
            b.Int("FirstArraySlice", s.Texture1DArray.FirstArraySlice);
            b.Int("ArraySize", s.Texture1DArray.ArraySize);
            break;
        }
        ...
        {
            auto b = v.Nested("Texture2D");
            b.Int("MipSlice", s.Texture2D.MipSlice);
            b.Int("PlaneSlice", s.Texture2D.PlaneSlice);
            break;
        }
        ...
        {
            auto b = v.Nested("Texture2DArray");
            b.Int("MipSlice", s.Texture2DArray.MipSlice);
            b.Int("FirstArraySlice", s.Texture2DArray.FirstArraySlice);
            b.Int("ArraySize", s.Texture2DArray.ArraySize);
            b.Int("PlaneSlice", s.Texture2DArray.PlaneSlice);
            break;
        ...
        {
            auto b = v.Nested("Texture3D");
            b.Int("MipSlice", s.Texture3D.MipSlice);
            b.Int("FirstWSlice", s.Texture3D.FirstWSlice);
            b.Int("WSize", s.Texture3D.WSize);
            break;
        }
        default: break;
    }
...
template <typename V>
void Reflect(V& v, D3D12_RENDER_TARGET_VIEW_DESC& s)
{
    R_ENUM(Format, DXGI_FORMAT);
...
template <typename V>
void Reflect(V& v, D3D12_DEPTH_STENCIL_VIEW_DESC& s)
{
    R_ENUM(Format, DXGI_FORMAT);
...
template <typename V>
void Reflect(V& v, D3D12_CONSTANT_BUFFER_VIEW_DESC& s)
{
    v.Address("BufferLocation", s.BufferLocation);
    R_INT(SizeInBytes);
}

template <typename V>
void Reflect(V& v, D3D12_SAMPLER_DESC& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_VERTEX_BUFFER_VIEW& s)
{
    v.Address("BufferLocation", s.BufferLocation);
    R_INT(SizeInBytes);
    R_INT(StrideInBytes);
...
template <typename V>
void Reflect(V& v, D3D12_INDEX_BUFFER_VIEW& s)
{
    v.Address("BufferLocation", s.BufferLocation);
    R_INT(SizeInBytes);
    R_ENUM(Format, DXGI_FORMAT);
...
template <typename V>
void Reflect(V& v, D3D12_STREAM_OUTPUT_BUFFER_VIEW& s)
{
    v.Address("BufferLocation", s.BufferLocation);
    R_INT(SizeInBytes);
    v.Address("BufferFilledSizeLocation", s.BufferFilledSizeLocation);
}
...
template <typename V>
void Reflect(V& v, D3D12_INPUT_ELEMENT_DESC& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_INPUT_LAYOUT_DESC& s)
{
    R_ARRAY(pInputElementDescs, NumElements);
}

template <typename V>
void Reflect(V& v, D3D12_SO_DECLARATION_ENTRY& s)
{
    R_INT(Stream);
    v.String("SemanticName", s.SemanticName);
    R_INT(SemanticIndex);
    R_INT(StartComponent);
    R_INT(ComponentCount);
    R_INT(OutputSlot);
}
template <typename V>
void Reflect(V& v, D3D12_STREAM_OUTPUT_DESC& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_RENDER_TARGET_BLEND_DESC& s)
{
    R_BOOL(BlendEnable);
...
template <typename V>
void Reflect(V& v, D3D12_BLEND_DESC& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_RASTERIZER_DESC& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_DEPTH_STENCILOP_DESC& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_DEPTH_STENCIL_DESC& s)
{
    R_BOOL(DepthEnable);
...
template <typename V>
void Reflect(V& v, D3D12_DEPTH_STENCIL_DESC1& s)
{
    R_BOOL(DepthEnable);
    R_ENUM(DepthWriteMask, D3D12_DEPTH_WRITE_MASK);
    R_ENUM(DepthFunc, D3D12_COMPARISON_FUNC);
...
template <typename V>
void Reflect(V& v, D3D12_GRAPHICS_PIPELINE_STATE_DESC& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_COMPUTE_PIPELINE_STATE_DESC& s)
{
    R_OBJECT(pRootSignature, "ID3D12RootSignature");
...
template <typename V>
void Reflect(V& v, D3D12_DESCRIPTOR_RANGE& s)
{
    R_ENUM(RangeType, D3D12_DESCRIPTOR_RANGE_TYPE);
    R_INT(NumDescriptors);
    R_INT(BaseShaderRegister);
    R_INT(RegisterSpace);
    R_INT(OffsetInDescriptorsFromTableStart);
}
template <typename V>
void Reflect(V& v, D3D12_DESCRIPTOR_RANGE1& s)
{
    R_ENUM(RangeType, D3D12_DESCRIPTOR_RANGE_TYPE);
    R_INT(NumDescriptors);
    R_INT(BaseShaderRegister);
...
template <typename V, typename Parameter>
void ReflectRootParameter(V& v, Parameter& s, bool flags)
{
    ...
    switch (s.ParameterType)
    {
        ...
        case D3D12_ROOT_PARAMETER_TYPE_32BIT_CONSTANTS:
        {
            ...
            b.Int("ShaderRegister", s.Constants.ShaderRegister);
            b.Int("RegisterSpace", s.Constants.RegisterSpace);
        ...
        default:
        {
            ...
            b.Int("ShaderRegister", s.Descriptor.ShaderRegister);
            b.Int("RegisterSpace", s.Descriptor.RegisterSpace);
            (void)flags;
            break;
        }
    }
...
template <typename V>
void Reflect(V& v, D3D12_ROOT_PARAMETER& s)
{
    ReflectRootParameter(v, s, false);
}
template <typename V>
void Reflect(V& v, D3D12_ROOT_PARAMETER1& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_STATIC_SAMPLER_DESC& s)
{
    R_ENUM(Filter, D3D12_FILTER);
    R_ENUM(AddressU, D3D12_TEXTURE_ADDRESS_MODE);
    R_ENUM(AddressV, D3D12_TEXTURE_ADDRESS_MODE);
...
template <typename V>
void Reflect(V& v, D3D12_ROOT_SIGNATURE_DESC& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_ROOT_SIGNATURE_DESC1& s)
{
    R_ARRAY(pParameters, NumParameters);
    R_ARRAY(pStaticSamplers, NumStaticSamplers);
    R_FLAGS(Flags, D3D12_ROOT_SIGNATURE_FLAGS);
...
template <typename V>
void Reflect(V& v, D3D12_VERSIONED_ROOT_SIGNATURE_DESC& s)
{
    R_ENUM(Version, D3D_ROOT_SIGNATURE_VERSION);
    if (s.Version == D3D_ROOT_SIGNATURE_VERSION_1_0)
        R_STRUCT(Desc_1_0);
    else if (s.Version == D3D_ROOT_SIGNATURE_VERSION_1_1)
        R_STRUCT(Desc_1_1);
}

template <typename V>
void Reflect(V& v, D3D12_DESCRIPTOR_HEAP_DESC& s)
{
    R_ENUM(Type, D3D12_DESCRIPTOR_HEAP_TYPE);
    R_INT(NumDescriptors);
    R_FLAGS(Flags, D3D12_DESCRIPTOR_HEAP_FLAGS);
    R_INT(NodeMask);
}
template <typename V>
void Reflect(V& v, D3D12_COMMAND_QUEUE_DESC& s)
{
    R_ENUM(Type, D3D12_COMMAND_LIST_TYPE);
    R_ENUM(Priority, D3D12_COMMAND_QUEUE_PRIORITY);
    R_FLAGS(Flags, D3D12_COMMAND_QUEUE_FLAGS);
    R_INT(NodeMask);
}
template <typename V>
void Reflect(V& v, D3D12_QUERY_HEAP_DESC& s)
{
    R_ENUM(Type, D3D12_QUERY_HEAP_TYPE);
    R_INT(Count);
    R_INT(NodeMask);
}

template <typename V>
void Reflect(V& v, D3D12_INDIRECT_ARGUMENT_DESC& s)
{
    ...
    switch (s.Type)
    {
        ...
        {
            auto b = v.Nested("VertexBuffer");
            b.Int("Slot", s.VertexBuffer.Slot);
            break;
        }
        case D3D12_INDIRECT_ARGUMENT_TYPE_CONSTANT:
        {
            auto b = v.Nested("Constant");
            b.Int("RootParameterIndex", s.Constant.RootParameterIndex);
            b.Int("DestOffsetIn32BitValues", s.Constant.DestOffsetIn32BitValues);
            b.Int("Num32BitValuesToSet", s.Constant.Num32BitValuesToSet);
            break;
        }
        case D3D12_INDIRECT_ARGUMENT_TYPE_CONSTANT_BUFFER_VIEW:
        {
            auto b = v.Nested("ConstantBufferView");
            b.Int("RootParameterIndex", s.ConstantBufferView.RootParameterIndex);
            break;
        }
        case D3D12_INDIRECT_ARGUMENT_TYPE_SHADER_RESOURCE_VIEW:
        {
            auto b = v.Nested("ShaderResourceView");
            b.Int("RootParameterIndex", s.ShaderResourceView.RootParameterIndex);
            break;
        }
        case D3D12_INDIRECT_ARGUMENT_TYPE_UNORDERED_ACCESS_VIEW:
        {
            auto b = v.Nested("UnorderedAccessView");
            b.Int("RootParameterIndex", s.UnorderedAccessView.RootParameterIndex);
            break;
        }
...
template <typename V>
void Reflect(V& v, D3D12_COMMAND_SIGNATURE_DESC& s)
{
    R_INT(ByteStride);
...
template <typename V>
void Reflect(V& v, D3D12_RESOURCE_BARRIER& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_RENDER_PASS_BEGINNING_ACCESS& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_RENDER_PASS_ENDING_ACCESS_RESOLVE_SUBRESOURCE_PARAMETERS& s)
{
    R_INT(SrcSubresource);
    R_INT(DstSubresource);
    R_INT(DstX);
    R_INT(DstY);
    R_STRUCT(SrcRect);
}
template <typename V>
void Reflect(V& v, D3D12_RENDER_PASS_ENDING_ACCESS& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_RENDER_PASS_RENDER_TARGET_DESC& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_RENDER_PASS_DEPTH_STENCIL_DESC& s)
{
    v.CpuHandle("cpuDescriptor", s.cpuDescriptor);
...
template <typename V>
void Reflect(V& v, D3D12_DISCARD_REGION& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_GPU_VIRTUAL_ADDRESS_AND_STRIDE& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_GPU_VIRTUAL_ADDRESS_RANGE& s)
{
    v.Address("StartAddress", s.StartAddress);
    R_INT(SizeInBytes);
}
...
template <typename V>
void Reflect(V& v, D3D12_GPU_VIRTUAL_ADDRESS_RANGE_AND_STRIDE& s)
{
    v.Address("StartAddress", s.StartAddress);
    R_INT(SizeInBytes);
    R_INT(StrideInBytes);
...
template <typename V>
void Reflect(V& v, D3D12_DISPATCH_RAYS_DESC& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_RAYTRACING_GEOMETRY_TRIANGLES_DESC& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_RAYTRACING_GEOMETRY_AABBS_DESC& s)
{
    R_INT(AABBCount);
    R_STRUCT(AABBs);
}
...
template <typename V>
void Reflect(V& v, D3D12_RAYTRACING_GEOMETRY_DESC& s)
{
    ...
    if (s.Type == D3D12_RAYTRACING_GEOMETRY_TYPE_PROCEDURAL_PRIMITIVE_AABBS)
        R_STRUCT(AABBs);
    else
        R_STRUCT(Triangles);
}
 ...
 */
template <typename V>
void Reflect(V& v, D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_INPUTS& s)
{
    ...
    else if (s.Type == D3D12_RAYTRACING_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL)
    {
        ...
        if (!s.pGeometryDescs)
        {
            ...
            if (s.pGeometryDescs)
                s.DescsLayout = D3D12_ELEMENTS_LAYOUT_ARRAY;
        }
    }
}

template <typename V>
void Reflect(V& v, D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESC& s)
{
...
template <typename V>
void Reflect(V& v, D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_DESC& s)
{
