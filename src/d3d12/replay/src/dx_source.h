...
DX_TYPE_NAME(D3D12_RAYTRACING_GEOMETRY_DESC)
DX_TYPE_NAME(D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESC)
DX_TYPE_NAME(D3D12_DISPATCH_RAYS_DESC)
DX_TYPE_NAME(D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_DESC)
