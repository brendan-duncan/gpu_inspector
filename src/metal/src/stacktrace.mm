...
{
    return module.rfind("libmtlinsp", 0) == 0 || module == "Metal" || module.rfind("AGX", 0) == 0 || module.rfind("libobjc", 0) == 0 || module.rfind("MTLCompiler", 0) == 0 || module.rfind("MTLDebug", 0) == 0 || module.rfind("libMTL", 0) == 0;
}
    ...
    for (uint64_t address : addresses)
    {
        ...
        if (dladdr((void*)(uintptr_t)(address - 1), &info))
        {
            ...
            if (info.dli_fbase != nullptr)
                f.offset = address - (uint64_t)(uintptr_t)info.dli_fbase;
