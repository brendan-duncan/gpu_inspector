...
test("initialize answers the client's protocol version, and every tool is listed with a schema", async () => {
  ...
  for (const name of ["open_capture", "get_capture_summary", "get_bottlenecks", "get_command", "read_texture", "read_vertices", "get_mesh_output", "get_draw_overlay", "debug_shader", "get_shader", "compare_captures"]) {
