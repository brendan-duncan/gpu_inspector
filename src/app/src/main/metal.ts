...
// DYLD_INSERT_LIBRARIES and takes the API's entry points itself (see src/metal/README.md). That makes
...
/**
 * The environment the capture library reads (src/metal/src/transport.mm, swizzle.mm).
 *
 ...
 * those lines as validation messages (src/metal/src/validation.mm). A variable the user already set
