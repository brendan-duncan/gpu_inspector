...
contextBridge.exposeInMainWorld("inspector", {
  ...
  replayEdited: (opts: unknown) => ipcRenderer.invoke("inspector:replayEdited", opts),
  exportCpp: (opts: unknown) => ipcRenderer.invoke("inspector:exportCpp", opts),
  releaseReplay: (key: string) => ipcRenderer.invoke("inspector:releaseReplay", key),
  ...
  shaderText: (spirv: Uint8Array, mode: string, pdbDirs?: string[]) => ipcRenderer.invoke("inspector:shaderText", spirv, mode, pdbDirs),
