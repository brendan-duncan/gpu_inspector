...
// Vulkan capture is replayed for it (vkinsp_replay --pixel --pixel-data, src/replay/src/history.cpp); a
// Metal application follows the pixel while capturing (a capture with `pixelHistory`,
// src/metal/src/pixel_history.mm). Both write the same JSON; this reads it and says it in words, for the
